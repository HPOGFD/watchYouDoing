...
interface WatchlistCardProps {
  movie: MovieData;
  removeFromWatchlist: (title: string) => void; // Updated to accept title
  addToSeenItList: (id: string | number) => void; // Updated to accept id
  ...
  return (
    <div className="watchlist-card border rounded-lg shadow p-4 bg-white">
      ...
      <div className="mt-4 flex gap-2">
        <button
          onClick={() => addToSeenItList(movie.id)}
